...
// import pgpText from 'raw-loader!./pgp.txt'; // PGP key disabled
...
async function surprisinglyShortAttentionSpan() {
  ...
  // pgpEl.innerHTML = pgpText; // PGP key disabled
  ...
  while(Date.now() - 1000 > start) {
    ...
    // styleEl.scrollTop = pgpEl.scrollTop = Infinity; // PGP key disabled
...
function getEls() {
  ...
  // pgpEl = document.getElementById('pgp-text'); // PGP key disabled
